...
void floatToStr(float f, char *buf, int precision) {
    int intPart = (int)f;
    int fracPart = (int)((f - intPart) * pow(10, precision));
    sprintf(buf, "%d.%0*d", intPart, precision, abs(fracPart));
}
